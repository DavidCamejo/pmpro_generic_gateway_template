 ...
 */
function pmprogpg_getOptions( int $level_id ) {
        // Set the default options.
        $options = array(
                'setting' => 0, // Not allowing users to pay with generic payment.
        ...
        if ( $level_id > 0 ) {
                ...
                $db_options = get_option( 'pmpro_generic_gateway_options_' . $level_id, false );
